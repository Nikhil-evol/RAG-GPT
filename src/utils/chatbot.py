...
class ChatBot:
    ...
    def respond(
        ...
        if data_type == "Preprocessed doc":
            ...
            chatbot.append({
                "role": "assistant",
                "content": "Please choose a valid document source from the 'RAG with' dropdown before asking a question.",
            })
            return "", chatbot, None
        ...
        if vectordb is None:
            chatbot.append({
                "role": "assistant",
                "content": "The selected document store is unavailable. Please upload or preprocess the documents again.",
            })
            return "", chatbot, None
        ...
        response = APPCFG.llm_client.chat.completions.create(
